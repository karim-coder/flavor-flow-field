  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 z-0">
        <div 
          className={cn(
            "absolute inset-0 bg-[url('https://images.unsplash.com/photo-1414235077428-338989a2e8c0?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=3774&q=80')] bg-cover bg-center",
      ...
      <div className="relative z-10 h-full flex flex-col items-center justify-center px-4 sm:px-6 lg:px-8">
        <div className="text-center max-w-5xl mx-auto">
          ...
          <FadeIn delay={0.7} direction="up" duration={1.2} initialOpacity={0}>
            <h1 className="text-4xl sm:text-5xl md:text-7xl text-white font-serif font-light leading-tight tracking-wide mb-8">
          ...
          <FadeIn delay={1.5} direction="up" duration={1.2} initialOpacity={0}>
